        ...
        <div>
          ...
          <div class="flex gap-2 mt-2 flex-wrap">
            ${(p.images || []).map(img => `
              <img
                src="${img}"
                class="w-16 h-16 object-cover border cursor-pointer thumb rounded"
              >
            `).join("")}
          </div>
        </div>
        ...
        <div>
          ...
          ${
            p.isSale
              ...
              `
              : `
                <div class="mt-3 text-2xl text-red-500 font-bold">
                  ${formatPrice(p.price)}
                </div>
              `
          }
          ...
          <button
            id="addBtn"
            class="mt-5 bg-black text-white px-5 py-2"
          >
            加入購物車
          </button>
